...
async def data_fetcher(query):
    ...
    result = llm.with_structured_output(sqlobject).ainvoke(sql_format_input)
    result = await result
    ...
    print('A')
    markdown_response = llm.with_structured_output(stateobject).ainvoke(markdown_format_input)
    markdown_response = await markdown_response
    ...
    chart_response = llm.with_structured_output(chartobject).ainvoke(chart_format_input)
    chart_response = await chart_response
    print('C')
